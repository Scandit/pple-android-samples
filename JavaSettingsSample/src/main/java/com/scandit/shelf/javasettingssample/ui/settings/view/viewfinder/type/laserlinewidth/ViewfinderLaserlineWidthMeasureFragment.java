...
public class ViewfinderLaserlineWidthMeasureFragment extends MeasureUnitFragment {

    public static ViewfinderLaserlineWidthMeasureFragment newInstance() {
        return new ViewfinderLaserlineWidthMeasureFragment();
    }

    private ViewfinderLaserlineWidthViewModel viewModel;

    @Override
    public void onCreate(@Nullable Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        viewModel = new ViewModelProvider(this).get(ViewfinderLaserlineWidthViewModel.class);
    }

    @Override
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        super.onViewCreated(view, savedInstanceState);
        setUpToolbar(rootView.findViewById(R.id.toolbar), getString(R.string.width), true);
    }
