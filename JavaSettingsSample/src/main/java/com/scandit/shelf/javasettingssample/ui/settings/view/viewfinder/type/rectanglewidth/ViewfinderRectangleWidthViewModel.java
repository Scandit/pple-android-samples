...
public class ViewfinderRectangleWidthViewModel extends ViewfinderTypeViewModel {

    private final ViewfinderRepository repository = ViewfinderRepository.getCurrentSettings();

    void valueChanged(float newValue) {
        MeasureUnit currentMeasureUnit = repository.getRectangularViewfinderWidth().getUnit();
        repository.setRectangularViewfinderWidth(
    ...
    void measureChanged(MeasureUnit measureUnit) {
        float currentValue = repository.getRectangularViewfinderWidth().getValue();
        repository.setRectangularViewfinderWidth(
    ...
    FloatWithUnit getCurrentWidth() {
        return repository.getRectangularViewfinderWidth();
    }
}
