...
public class SettingsOverviewAdapter
        extends RecyclerView.Adapter<SettingsOverviewAdapter.ViewHolder> {

    private final Callback callback;
    private final SettingsOverviewEntry[] entries;

    SettingsOverviewAdapter(SettingsOverviewEntry[] entries, Callback callback) {
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        final SettingsOverviewEntry currentEntry = entries[position];
    ...
    interface Callback {
        void onEntryClick(SettingsOverviewEntry entry);
    }
}
