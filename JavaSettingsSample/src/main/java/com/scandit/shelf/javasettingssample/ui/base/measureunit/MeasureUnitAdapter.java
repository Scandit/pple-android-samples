...
package com.scandit.shelf.javasettingssample.ui.base.measureunit;
...
public class MeasureUnitAdapter extends RecyclerView.Adapter<MeasureUnitAdapter.ViewHolder> {
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        ...
        holder.itemView.setOnClickListener(v -> callback.onMeasureUnitClick(currentEntry));
    }
    ...
    private static class MeasureUnitEntryDiff extends TypedDiffUtilCallback<MeasureUnitEntry> {
