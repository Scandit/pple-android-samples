...
import com.scandit.shelf.kotlincomposesimplesample.ui.theme.TransparentGreen
import com.scandit.shelf.kotlincomposesimplesample.ui.theme.TransparentGrey
import com.scandit.shelf.kotlincomposesimplesample.ui.theme.TransparentRed
...
class MainActivityViewModel : ViewModel(), PriceCheckListener {
    ...
    override fun onCorrectPrice(priceCheckResult: PriceCheckResult) {
        ...
        snackbarFlow.tryEmit(SnackbarData(priceCheckResult.toMessage(), TransparentGreen))
    }
    ...
    override fun onWrongPrice(priceCheckResult: PriceCheckResult) {
        ...
        // we will pass details of a snackbar to the Activity to be displayed on a screen.
        snackbarFlow.tryEmit(SnackbarData(priceCheckResult.toMessage(), TransparentRed))
    }
    ...
    override fun onUnknownProduct(priceCheckResult: PriceCheckResult) {
        ...
        // we will pass details of a snackbar to the Activity to be displayed on a screen.
        snackbarFlow.tryEmit(SnackbarData(priceCheckResult.toMessage(), TransparentGrey))
    }
